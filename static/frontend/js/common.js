...
$(document).ready(function($) {
  "use strict";
	...
	if($(window).width() < 990){
		...
		$('.logo').attr("class", "logo_small")
	}
	else{
		$('.logo_small').attr("src","https://elearning.santannapisa.it/pluginfile.php/1/theme_adaptable/logo/1661430207/logo2x.png");
		$('.logo_small').attr("class", "logo")
	}
